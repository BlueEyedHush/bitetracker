...
Recipe.find({}).removeAsync()
  .then(() => {
    ...
    '6. Unroll waxed paper cylinder, causing chocolate to crack creating shards. Garnish each cupcake with chocolate shards. Store in refrigerator.',
      ...
      author: 'test',
      description: 'When I was in Vicenza, Italy at an open market downtown, I smelled this scrumptious smell of roast chicken at this stand. So I bought one of their chickens and looked what they stuffed in the cavity to make it taste so good! I also do my turkeys like this too!',
      ingredients: [
        {
          name: 'Whole chicken',
          qty: 3,
      ...
      image: 'http://images.media-allrecipes.com/userphotos/560x315/409990.jpg'
    },
      {
      ...
      'Bake for 15 to 17 minutes in the preheated oven, or until the edges are lightly toasted. Cool on baking sheets for a few minutes before transferring to wire racks to cool completely.',
        image: 'http://images.media-allrecipes.com/userphotos/560x315/1107530.jpg'
      },
      {
        title: 'White Bean Chicken Chili',
        author: 'test',
        description: 'This recipe was passed down from a friend, and now it is one of our favorites! It\'s great to make whenever there is left over chicken or turkey around!',
        ingredients: [
          {
            name: 'Vegetable oil',
            qty: 2,
        ...
        instructions: 'Heat oil, and cook onion and garlic until soft.\n'+
        ...
        image: 'http://images.media-allrecipes.com/userphotos/560x315/2568455.jpg'
      },
      {
        title: 'Gourmet Mushroom Risotto',
        author: 'test',
        description: 'Authentic Italian-style risotto cooked the slow and painful way, but oh so worth it. Complements grilled meats and chicken dishes very well. Check the rice by biting into it. It should be slightly al dente (or resist slightly to the tooth but not be hard in the center).',
        ingredients: [
          {
        ...
        'Season chicken with salt and pepper to taste. Stuff with the onion and rosemary. Place chicken in a 9x13 inch baking dish or roasting dish.\n' +
        'Roast in the preheated oven for 2 to 2 1/2 hours, or until chicken is cooked through and juices run clear. Cooking time will vary a bit depending on the size of the bird.',
        image: 'http://images.media-allrecipes.com/userphotos/560x315/246711.jpg'
