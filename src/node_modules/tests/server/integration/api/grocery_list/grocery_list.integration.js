...
describe('GroceryList API:', () => {
  ...
  describe('PUT /api/grocery_lists/:id', () => {
    ...
    it('should respond with the new groceryList', () => {
      updatedGroceryList.title.should.equal('Updated GroceryList');
    });
  });
  ...
  describe('DELETE /api/grocery_lists/:id', () => {
    ...
    it('should respond with 404 when groceryList does not exist', (done) => {
      request(app)
        .delete(`/api/grocery_lists/${new mongoose.Types.ObjectId()}`)
        .set('Cookie', tokenCookie())
        .expect(404)
        .end((err) => {
          if (err) {
