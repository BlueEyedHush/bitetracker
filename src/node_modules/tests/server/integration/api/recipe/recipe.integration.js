...
describe('Recipe API:', () => {
  ...
  describe('POST /api/recipes', () => {
    beforeEach(() => {
      return request(app)
        ...
        .send({
          title: 'New Recipe',
          instructions: 'This is the brand new recipe!!!',
        })
        .expect(201)
        .expect('Content-Type', /json/)
    ...
    it('should respond with the newly created recipe', () => {
      ...
      newRecipe.instructions.should.equal('This is the brand new recipe!!!');
    });
  });
  ...
  describe('GET /api/recipes/:id', () => {
    ...
    it('should respond with the requested recipe', () => {
      ...
      recipe.instructions.should.equal('This is the brand new recipe!!!');
    });
  });
  ...
  describe('PUT /api/recipes/:id', () => {
    ...
    beforeEach(() => {
      return request(app)
        ...
        .send({
          ...
          instructions: 'This is the updated recipe!!!',
        })
        .expect(200)
        .expect('Content-Type', /json/)
    ...
    it('should respond with the updated recipe', () => {
      ...
      updatedRecipe.instructions.should.equal('This is the updated recipe!!!');
    });
  });
