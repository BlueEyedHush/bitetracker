...
describe('<RecipeCard />', () => {
  ...
  context('with recipe image', () => {
    ...
    const subject = wrapper(recipeWithImage).find(Card.Media);

    it('renders <Card.Media/> with recipe image', () => {
      expect(subject).to.have.lengthOf(1);
  ...
  context('with no recipe image', () => {
    const subject = wrapper(recipe).find(Card.Media);

    it('renders <Card.Media/> with default image', () => {
      expect(subject).to.have.lengthOf(1);
