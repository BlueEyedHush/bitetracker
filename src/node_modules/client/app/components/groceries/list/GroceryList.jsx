...
function addItem(list){
  GroceryListActions.addItem(list._id, {
    _id : list.listName.value,
...
const List = ({ list, onItemToggle }) => (
  <div>
    ...
    <input type="text" ref={(ref) => list.listName = ref } placeholder="Add item.."/>
    <button className="add-item" onClick={() => (addItem(list))}>+</button>
