...
const LoginComponent = React.createClass({
  ...
  render() {
    return (
      <form>
        <FormGroup className="centerText" controlId="login">
          <LoginErrorAlert errorType={this.state.status}/>
          <FormControl className="inputbox centerText" type="text"
                       value={this.state.username}
                       placeholder="Username"
                       onChange={this.usernameChanged}/>
          <FormControl className="inputbox centerText" type="password"
                       value={this.state.password}
                       placeholder="Password"
                       onChange={this.passwordChanged}/>
          <p className="normalText centerText">Forgot password?</p>
          <Button className="inputButton" bsStyle="primary" onClick={this.submit}>Log in</Button>
        </FormGroup>
      </form>
    );
  }
      ...
      <div className="wrapper">
        ...
        <div className="wideTile white">
          ...
          <div className="tile smallMargin">
            ...
            <LoginComponent authService={authSrv}/>
          </div>
